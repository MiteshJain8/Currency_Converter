...
<head>
    ...
    <!-- add icon link -->
    <link rel="icon" href="image-removebg-preview.png" type="png">
</head>
...
<form class="container">
    ...
    <form action="CCServlet" method="post"></form>
    <div class="main">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control searchBox" placeholder="0.00" id="oamount" name="fromValue">
